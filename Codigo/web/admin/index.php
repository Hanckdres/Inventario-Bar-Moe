...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="index.php">Bar mou</a>
    ...
    <?php 
    //$sql="SELECT * from tbl_menuitem order by menuItemName DESC";
    $sql="SELECT * from tbl_menuitem order by price ASC";
    ...
    <tr>
      ...
      <td><?php echo $mostrar['menuItemName'] ?></td>
